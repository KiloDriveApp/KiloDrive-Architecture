...
REQUIRED_PATHS = (
    ...
    "docs/architecture/runtime-profiles.md",
    "docs/architecture/authoritative-foreign-exchange.md",
    "docs/architecture/release-1.0.0-144.md",
    ...
    "docs/runbooks/foreign-exchange-readiness.md",
    "docs/runbooks/payment-operation-recovery.md",
    "docs/runbooks/runtime-profile-rollout.md",
    "docs/runbooks/store-entitlement-reconciliation.md",
    "docs/adr/README.md",
    ...
    "docs/adr/012-native-api-v1-and-generated-contract.md",
    "docs/adr/013-runtime-profile-composition.md",
    "docs/adr/014-authoritative-foreign-exchange.md",
    "docs/adr/015-account-membership-notification-authority.md",
